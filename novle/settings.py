"""
Django settings for Novle project.
...
MIDDLEWARE = [
    ...
    "novle.middleware.RootWhiteNoiseMiddleware",
...
WSGI_APPLICATION = 'novle.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgres://chasec@127.0.0.1:5432/novle",
        conn_max_age=600,
    )
}
