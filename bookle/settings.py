"""
Django settings for bookle project.
...
MIDDLEWARE = [
    ...
    "bookle.middleware.RootWhiteNoiseMiddleware",
...
WSGI_APPLICATION = 'bookle.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgres://chasec@127.0.0.1:5432/bookle",
        conn_max_age=600,
    )
}
